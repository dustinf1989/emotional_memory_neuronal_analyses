...
elseif ~isempty(cfg.trl)
  ...
  for iTrl=1:size(newtrl, 1)
    ...
    data.trial{iTrl} = ft_fetch_data(dataold, 'header', hdr, 'begsample', begsample(iTrl), 'endsample', endsample(iTrl), 'chanindx', 1:hdr.nChans, 'skipcheckdata', 1, 'allowoverlap', 1); % DF replaced this line 9Aug 2022
